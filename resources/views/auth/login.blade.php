              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h6 class="h6 text-gray-900"><b>INVENTARIS SARANA PRASARANA</b></h5>
                      <h6 class="h6 text-gray-900 mb-2">SMK NEGERI 1 CIMAHI</h5>
                      <img style="width: 125px;" src="{{ asset('assets/AdminLTE/dist/img/SMKN1CIMAHI.png') }}">
                      <h6 class="h6 text-gray-900 mt-4">LOGIN</h1>
                  </div>
